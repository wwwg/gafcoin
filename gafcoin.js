(() => {
    ...
    const BLOCK_SIZE = 20, // number of transactions that make a block
        ...
        PROTOCOL_VERSION = 5; // proto version; versions lower than this are rejected by nodes
    ...
    let init = () => {
        ...
        for (let i = 0; i < BLOCK_SIZE; ++i) {
            let tx = new Transaction('genesis', '0435ef20199d5d2c434b57359af163271c9835c58094b101688978c5f9b478036e873af47d12c75e5d7cc02ff0d62ef8b04e4965d4f65214d87823696728761fdc', 100000, 1514764801);
            genesisTxs.push(tx);
        }
